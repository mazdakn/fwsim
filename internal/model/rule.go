...
func (r *Rule) UnmarshalYAML(unmarshal func(interface{}) error) error {
	ry, err := config.UnmarshalRuleFromYAML(unmarshal)
	if err != nil {
		return err
	}

	srcNet, dstNet, protocol, srcPort, dstPort, actionStr, err := config.ParseRuleYAML(ry)
	if err != nil {
		return err
	}
...
func (r *Rule) MarshalYAML() (interface{}, error) {
	return config.MarshalRuleToYAML(r.SrcNet, r.DstNet, r.Protocol, r.SrcPort, r.DstPort, r.Action.String()), nil
}
